...
function JoinForm() {
  ...
  return (
    <div id="connect-form" className="bg-light-blue p-5 rounded-lg md:my-7">
      <form
        ...
        <div className="grid grid-cols-6 gap-6">
              <div className="col-span-6 sm:col-span-3">
                ...
                autocomplete="given-name" className="mt-1 focus:outline-none focus:ring focus:border-blue-50 "/>
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                autocomplete="family-name" className="mt-1 focus:outline-none focus:ring focus:border-blue-50 "/>
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                <label for="studentAff" className="block text-sm font-medium text-gray-700">Student Affiliation</label>
                <select
